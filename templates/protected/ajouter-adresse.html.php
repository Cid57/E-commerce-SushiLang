        ...
        <div class="col-12 col-md-4">
            ...
            <form method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors) && !empty($errors['number']) ? 'is-invalid' : '' ?>" name="number" id="number" required placeholder="ex: 86">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors) && !empty($errors['street']) ? 'is-invalid' : '' ?>" name="street" id="street" required placeholder="ex: rue des sushis">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors) && !empty($errors['zip_code']) ? 'is-invalid' : '' ?>" name="zip_code" id="zip_code" required placeholder="ex: 57000">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors) && !empty($errors['city']) ? 'is-invalid' : '' ?>" name="city" id="city" required placeholder="ex: METZ">
