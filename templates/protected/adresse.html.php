        ...
        <div class="col-12 col-md-6">
            ...
            <form action="" method="POST">
                <fieldset class="mb-4">
                    ...
                    <?php foreach ($addresses as $address) : ?>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="billing_address" id="billingAddress<?= $address['id_address'] ?>" value="<?= $address['id_address'] ?>">
                ...
                <fieldset class="mb-4">
                    ...
                    <?php foreach ($addresses as $address) : ?>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="delivery_address" id="deliveryAddress<?= $address['id_address'] ?>" value="<?= $address['id_address'] ?>">
